...
typedef struct {
    ...
    uint8_t     observerMode;               /** indicates tag in Observer mode, ignore mismatched handle, skip block ACK 1:=Observer, 0:=Normal **/
    uint8_t     observerRdy;                /**ready to enter observer mode**/
