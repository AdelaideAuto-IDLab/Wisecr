...
;************************************************************************************************************************************/
	...
	; Why use MOV and increment? Surely this is slower than something like??:
	;
	; MOV.B	 0(R_readPtr), 0(R15)
	; MOV.B	 1(R_readPtr), 1(R15)
	; MOV.B	 2(R_readPtr), 2(R15)
	; ...
	;
	; Or even (if alignment is correct):
	;
	; MOV.W	 0(R_readPtr), 0(R15)
	; MOV.W	 2(R_readPtr), 2(R15)
	; MOV.W	 4(R_readPtr), 4(R15)
	; ....
