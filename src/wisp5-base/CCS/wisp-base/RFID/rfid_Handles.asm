...
ackWaits:
	...
	;Mute the EPC if in the observermode
...
;	MOV.W		#(DIVA_0|DIVS_0|DIVM_0), &CSCTL3;
	...
	; We sleep here even though we will eventually sleep in `wisp_doRFID` because in `wisp_doRFID`
	; we will wake up on the next RFID message. Here we stop responding to RFID commands to gain
	; more power
