...
void TI_MSPBoot_CI_PHYDL_Init(t_CI_Callback* CI_Callback)
{
    ...
    wispData.epcBuf[6] = 0;           // Unused data field ////////////////////////////////////////////Don't initialize the Test Touch voltage
    wispData.epcBuf[7] = 0x00;        // Unused data field
    wispData.epcBuf[8] = 0x00;        // Unused data field
    wispData.epcBuf[9] = *((volatile uint8_t *)&_Device_Version);  // Tag firmware version
...
//            P3OUT &= !BIT4;
//            P3DIR |= BIT4;// mark the Tactive finish.
//            P3OUT |= BIT5;
//            P3DIR |= BIT5;// mark the Ttrans start.
            WISP_doRFID();
//            P3OUT &= !BIT5;
//            P3DIR |= BIT5;// mark the Ttrans finish.
